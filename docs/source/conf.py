# -*- coding: utf-8 -*-
#
# versionfinder documentation build configuration file, created by
...
if is_rtd:
    ...
    htmlhelp_basename = 'versionfinderdoc'
...
latex_documents = [
  (master_doc, 'versionfinder.tex', u'versionfinder Documentation',
...
man_pages = [
    (master_doc, 'versionfinder', u'versionfinder Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'versionfinder', u'versionfinder Documentation',
   author, 'versionfinder', 'One line description of project.',
   'Miscellaneous'),
]
